...
These notes by Léo Belzile (HEC Montréal) are licensed under a \href{http://creativecommons.org/licenses/by-nc-sa/4.0/}{Creative Commons Attribution-NonCommercial-ShareAlike 4.0 International License} and were last compiled on 2022-11-23.
...
\protect\hypertarget{exm:diagplotcollege}{}\label{exm:diagplotcollege}We can look at the \texttt{college} data to see if the linear model assumptions hold.
\end{example}
...
\begin{example}
\protect\hypertarget{exm:poisonboxcox}{}\label{exm:poisonboxcox}The paper of Box and Cox consider survival time for 48 animals based on a randomized trial; these data are analyzed in Example 8.25 of \citet{SM:2008}. Three poisons were administered with four treatments; each factor combination contained four animals, chosen at random. There is strong evidence that both the choice of poison and treatment affect survival time.
...
\protect\hypertarget{exm:normalglmexpf}{}\label{exm:normalglmexpf}We consider a sample consisting of independent normal observations, \(Y_i \sim \mathsf{No}(\mu_i, \sigma^2)\), with
\begin{align*}
