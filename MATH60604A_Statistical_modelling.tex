...
These notes by Léo Belzile (HEC Montréal) are licensed under a \href{http://creativecommons.org/licenses/by-nc-sa/4.0/}{Creative Commons Attribution-NonCommercial-ShareAlike 4.0 International License} and were last compiled on 2022-02-10.
...
\begin{example}{}
ffalse\{-91-79-110-108-105-110-101-32-112-117-114-99-104-97-115-101-115-32-111-102-32-109-105-108-108-101-110-105-97-108-115-93-\}\fi{}
\protect\hypertarget{exm:achats-milleniaux}{}{\label{exm:achats-milleniaux} \textbackslash iffalse (Online purchases of millenials) \fi{} }
...
\begin{example}{}
ffalse\{-91-69-120-112-108-111-114-97-116-111-114-121-32-100-97-116-97-32-97-110-97-108-121-115-105-115-32-111-102-32-82-101-110-102-101-32-116-105-99-107-101-116-115-93-\}\fi{}
\protect\hypertarget{exm:renfe-aed}{}{\label{exm:renfe-aed} \textbackslash iffalse (Exploratory data analysis of Renfe tickets) \fi{} }First, read the documentation accompanying the dataset! The data base \texttt{renfe} contains the following variables:
\end{example}
...
\begin{example}{}
ffalse\{-91-65-117-116-111-32-100-97-116-97-93-\}\fi{}
\protect\hypertarget{exm:auto}{}{\label{exm:auto} \textbackslash iffalse (Auto data) \fi{} }We consider a linear regression model for the fuel autonomy of cars as a function of the power of their motor (measured in horsepower) from the \texttt{auto} dataset. The postulated model,
\[
...
\begin{remark}{}
ffalse\{-91-84-104-101-114-101-32-97-114-101-32-98-101-116-116-101-114-32-97-108-116-101-114-110-97-116-105-118-101-115-32-116-111-32-112-111-108-121-110-111-109-105-97-108-115-32-102-111-114-32-109-111-100-101-108-108-105-110-103-32-110-111-110-108-105-110-101-97-114-32-101-102-102-101-99-116-115-93-\}\fi{}
\textbackslash iffalse\{\} {Remark (There are better alternatives to polynomials for modelling nonlinear effects). } \fi{}Generally speaking, one uses flexible basis vectors (splines) rather than polynomials for smoothing when the relation between the response \(Y\) and an explanatory variable \(\mathrm{X}\) is nonlinear; one then adds a penalty term to prevent overfitting and control the wiggliness. A better (physical) understanding of the system, or a theoretical model can also guide the choice of functional form to use.
\end{remark}
...
\begin{example}{}
ffalse\{-91-87-97-103-101-32-105-110-101-113-117-97-108-105-116-121-32-105-110-32-97-110-32-65-109-101-114-105-99-97-110-32-99-111-108-108-101-103-101-93-\}\fi{}
\protect\hypertarget{exm:inequite-salariale}{}{\label{exm:inequite-salariale} \textbackslash iffalse (Wage inequality in an American college) \fi{} }We consider a multiple regression model for the \texttt{college} data that includes sex, academic rank, field of study and the number of years of service as regressors.
\end{example}
...
\begin{example}{}
ffalse\{-91-67-111-108-108-105-110-101-97-114-105-116-121-32-105-110-32-116-104-101-32-36-92-116-101-120-116-116-116-123-99-111-108-108-101-103-101-125-36-32-100-97-116-97-93-\}\fi{}
...
\begin{example}{}
ffalse\{-91-68-105-97-103-110-111-115-116-105-99-32-112-108-111-116-115-32-102-111-114-32-116-104-101-32-36-92-116-101-120-116-116-116-123-99-111-108-108-101-103-101-125-36-32-100-97-116-97-46-93-\}\fi{}
\protect\hypertarget{exm:diagplotcollege}{}{\label{exm:diagplotcollege} \textbackslash iffalse (Diagnostic plots for the \(\texttt{college}\) data.) \fi{} }We can look at the \texttt{college} data to see if the linear model assumptions hold.
\end{example}
...
\begin{example}{}
ffalse\{-91-78-111-114-109-97-108-32-115-97-109-112-108-101-115-32-97-110-100-32-111-114-100-105-110-97-114-121-32-108-101-97-115-116-32-115-113-117-97-114-101-115-93-\}\fi{}
\protect\hypertarget{exm:normal}{}{\label{exm:normal} \textbackslash iffalse (Normal samples and ordinary least squares) \fi{} }Suppose we have an independent normal sample of size \(n\) with mean \(\mu\) and variance \(\sigma^2\), where
...
\begin{example}{}
ffalse\{-91-66-111-120-45-45-67-111-120-32-116-114-97-110-115-102-111-114-109-97-116-105-111-110-93-\}\fi{}
\protect\hypertarget{exm:boxcox}{}{\label{exm:boxcox} \textbackslash iffalse (Box--Cox transformation) \fi{} }Sometimes, the assumption of normality of the error doesn't hold. If the data are strictly positive, one can consider a Box--Cox transformation,
\begin{align*}
y_i(\lambda)= \begin{cases}
(y^{\lambda}-1)/\lambda, & \lambda \neq 0\\
\ln(y), & \lambda=0.
...
\begin{example}{}
ffalse\{-91-80-111-105-115-115-111-110-32-100-105-115-116-114-105-98-117-116-105-111-110-32-97-115-32-101-120-112-111-110-101-110-116-105-97-108-32-102-97-109-105-108-121-32-109-101-109-98-101-114-93-\}\fi{}
\protect\hypertarget{exm:poissonglmexpf}{}{\label{exm:poissonglmexpf} \textbackslash iffalse (Poisson distribution as exponential family member) \fi{} }The mass function of the Poisson distribution is
\begin{align*}
...
\begin{example}{}
ffalse\{-91-78-111-114-109-97-108-32-100-105-115-116-114-105-98-117-116-105-111-110-32-97-115-32-109-101-109-98-101-114-32-111-102-32-116-104-101-32-101-120-112-111-110-101-110-116-105-97-108-32-102-97-109-105-108-121-93-\}\fi{}
\protect\hypertarget{exm:normalglmexpf}{}{\label{exm:normalglmexpf} \textbackslash iffalse (Normal distribution as member of the exponential family) \fi{} }We consider a sample consisting of independent normal observations, \(Y_i \sim \mathsf{No}(\mu_i, \sigma^2)\), with
\begin{align*}
...
\begin{example}{}
ffalse\{-91-84-114-97-110-115-102-111-114-109-105-110-103-32-97-32-110-111-110-108-105-110-101-97-114-32-114-101-103-114-101-115-115-105-111-110-32-109-111-100-101-108-32-105-110-116-111-32-97-32-108-105-110-101-97-114-32-109-111-100-101-108-32-116-104-114-111-117-103-104-32-97-32-108-105-110-107-32-102-117-110-99-116-105-111-110-93-\}\fi{}
\protect\hypertarget{exm:inverslinklm}{}{\label{exm:inverslinklm} \textbackslash iffalse (Transforming a nonlinear regression model into a linear model through a link function) \fi{} }
...
\begin{example}{}
ffalse\{-91-69-108-101-109-101-110-116-115-32-111-102-32-116-104-101-32-119-101-105-103-104-116-32-109-97-116-114-105-120-32-102-111-114-32-80-111-105-115-115-111-110-32-100-97-116-97-93-\}\fi{}
\protect\hypertarget{exm:weightpois}{}{\label{exm:weightpois} \textbackslash iffalse (Elements of the weight matrix for Poisson data) \fi{} }If we consider \(Y_i \sim \mathsf{Po}(\mu_i)\) with canonical link function \(\mu_i = \exp(\eta_i)\), then \(\partial \mu_i/\partial \eta_i =\exp(\eta_i)= \mu_i\) and thus \(w_i=\mu_i\).
\end{example}
...
\begin{example}{}
ffalse\{-91-68-101-118-105-97-110-99-101-32-102-111-114-32-99-111-109-109-111-110-32-103-101-110-101-114-97-108-105-122-101-100-32-108-105-110-101-97-114-32-109-111-100-101-108-115-93-\}\fi{}
\protect\hypertarget{exm:devglm}{}{\label{exm:devglm} \textbackslash iffalse (Deviance for common generalized linear models) \fi{} }Suppose that the model matrix of the model \(\mathbf{X}\) includes an intercept and let \(\widehat{\mu}_i\) denote the fitted mean. Then, the deviance for the normal generalized linear model with homoscedastic errors is \(D = \sum_{i=1}^n (y_i - \widehat{\mu}_i)^2\), which is the sum of squared residuals. For Poisson data, the saturated model has \(\widetilde{\mu}_i=y_i\) and \(D= 2\sum_{i=1}^n y_i \ln(y_i/\widehat{\mu}_i)\).
\end{example}
...
\begin{example}{}
ffalse\{-91-71-80-65-32-115-99-111-114-101-32-97-110-100-32-103-114-97-100-117-97-116-101-32-97-100-109-105-115-115-105-111-110-93-\}\fi{}
\protect\hypertarget{exm:gpaexample}{}{\label{exm:gpaexample} \textbackslash iffalse (GPA score and graduate admission) \fi{} }We consider a simple logistic model for graduate admission (yes/no) in universities across the USA as a function of their grade point average (GPA).
\end{example}
...
\begin{example}{}
ffalse\{-91-82-105-115-107-32-102-97-99-116-111-114-115-32-114-101-108-97-116-101-100-32-116-111-32-117-110-100-101-114-119-101-105-103-104-116-32-98-97-98-105-101-115-32-97-116-32-98-105-114-116-104-93-\}\fi{}
\protect\hypertarget{exm:birthweightex}{}{\label{exm:birthweightex} \textbackslash iffalse (Risk factors related to underweight babies at birth) \fi{} }We consider a medical example related to risk factors explaining the birth weight: the birth weight is dichotomized and classified as low if the infant weight is inferior to 2.5 kg (1) and 0 otherwise. The data were collected in a medical center in Massachusetts in 1986.
\end{example}
...
\begin{example}{}
ffalse\{-91-82-111-97-100-32-97-99-99-105-100-101-110-116-115-32-97-110-100-32-115-112-101-101-100-32-108-105-109-105-116-115-32-111-110-32-116-104-101-32-109-111-116-111-114-119-97-121-32-105-110-32-83-119-101-100-101-110-93-\}\fi{}
\protect\hypertarget{exm:roadsweden}{}{\label{exm:roadsweden} \textbackslash iffalse (Road accidents and speed limits on the motorway in Sweden) \fi{} }Sweden is a worlwide leader in road safety and has a long history of countermeasures to increase road traffic safety, including the Vision Zero program. Back in the 1960s, a study was conducted by the authorities to investigate the potential of speed limits on motorways to reduce the number of accidents. The \texttt{sweden} data contains the number of accidents on 92 matching days in both 1961 and 1962 \citep{Svensson:1981}; speed limits were in place on selected days in either year.
\end{example}
...
\begin{example}{}
ffalse\{-91-80-111-105-115-115-111-110-32-108-111-103-45-108-105-110-101-97-114-32-109-111-100-101-108-32-102-111-114-32-100-114-117-103-32-104-105-115-116-111-114-121-32-105-110-32-68-97-121-116-111-110-93-\}\fi{}
\protect\hypertarget{exm:poissonconting}{}{\label{exm:poissonconting} \textbackslash iffalse (Poisson log-linear model for drug history in Dayton) \fi{} }We consider data from \citet{Agresti:2019} on history of high school students near Dayton, Ohio. A survey asked students from grade 12 about their previous consumption of alcohol, cigarettes and marijuana (yes/no). The \(2 \times 2 \times 2\) table corresponds to a 12 by 4 data frame with three binary variables and one integer-valued response giving the counts.
\end{example}
...
\begin{example}{}
ffalse\{-91-67-104-105-99-107-101-110-32-103-114-111-119-116-104-32-99-117-114-118-101-93-\}\fi{}
\protect\hypertarget{exm:chickcurve}{}{\label{exm:chickcurve} \textbackslash iffalse (Chicken growth curve) \fi{} }We consider for illustration the growth curves of chicken who are administered four different diets. The purpose of the study was to determine which diet was most effective for weight gain.
\end{example}
...
\begin{example}{}
ffalse\{-91-71-101-111-109-101-116-114-105-99-32-100-105-115-116-114-105-98-117-116-105-111-110-93-\}\fi{}
\protect\hypertarget{exm:geomdist}{}{\label{exm:geomdist} \textbackslash iffalse (Geometric distribution) \fi{} }The \href{https://en.wikipedia.org/wiki/Geometric_distribution}{geometric distribution} is a model describing the number of Bernoulli trials with probability of success \(\pi\) required to obtain a first success. The mass function of \(Y \sim \mathsf{Geo}(\pi)\) is
\begin{align*}
...
\begin{example}{}
ffalse\{-91-80-111-105-115-115-111-110-32-100-105-115-116-114-105-98-117-116-105-111-110-93-\}\fi{}
\protect\hypertarget{exm:poissondist}{}{\label{exm:poissondist} \textbackslash iffalse (Poisson distribution) \fi{} }If the probability of success \(\pi\) of a Bernoulli event is small in the sense that \(m\pi \to \lambda\) when the number of trials \(m\) increases, then the number of success follows approximately a Poisson distribution with mass function
\begin{align*}
...
\begin{example}{}
ffalse\{-91-78-101-103-97-116-105-118-101-32-98-105-110-111-109-105-97-108-32-100-105-115-116-114-105-98-117-116-105-111-110-93-\}\fi{}
\protect\hypertarget{exm:negbindist}{}{\label{exm:negbindist} \textbackslash iffalse (Negative binomial distribution) \fi{} }The negative binomial distribution arises as a natural generalization of the geometric distribution if we consider the number of Bernoulli trials with probability of success \(\pi\) until we obtain \(m\) success. Let \(Y\) denote the number of failures: the order of success and failure doesn't matter, but for the latest trial which is a success. The mass function is thus
\begin{align*}
...
\begin{example}{}
ffalse\{-91-78-111-114-109-97-108-32-100-105-115-116-114-105-98-117-116-105-111-110-93-\}\fi{}
\protect\hypertarget{exm:normaldist}{}{\label{exm:normaldist} \textbackslash iffalse (Normal distribution) \fi{} }The normal distribution is ubiquitous in statistics because of the \href{CLT}{central limit theorem}. A random variable \(Y\) follows a normal distribution if its density function is
\begin{align*}
...
\begin{example}{}
ffalse\{-91-67-104-105-45-115-113-117-97-114-101-32-100-105-115-116-114-105-98-117-116-105-111-110-93-\}\fi{}
\protect\hypertarget{exm:chisqdist}{}{\label{exm:chisqdist} \textbackslash iffalse (Chi-square distribution) \fi{} }The chi-square distribution arises as null distribution of likelihood-based test. If \(\boldsymbol{Y} \sim \mathsf{No}_p(\boldsymbol{0}_p, \mathbf{I}_p)\), i.e., all components are independent and centered \(Y_i \sim \mathsf{No}(0, 1)\), then \(\sum_{i=1}^p Y_i^2\) follows a chi-square distribution with \(p\) degrees of freedom, denote \(\chi^2_p\). The square of a standard normal variate likewise follows a \(\chi^2_1\) distribution.

If we consider a sample of \(n\) normally distributed observations, the sample variance \((n-1)S^2/\sigma^2 \sim \chi^2_{n-1}\).
\end{example}

\begin{example}{}
ffalse\{-91-83-116-117-100-101-110-116-45-36-116-36-32-100-105-115-116-114-105-98-117-116-105-111-110-93-\}\fi{}
\protect\hypertarget{exm:studentdist}{}{\label{exm:studentdist} \textbackslash iffalse (Student-\(t\) distribution) \fi{} }If \(X \sim \mathsf{No}(0,1)\) independent of \(Y \sim \chi^{2}_\nu\), then
\begin{align*}
T = \frac{X}{\sqrt{Y/\nu}}
\end{align*}
