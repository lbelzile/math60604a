...
<p>Because the inputs of the estimator are random, the output is also random and change from one sample to the next: even if you repeat a recipe, you won’t get the exact same result every time, as in <a href="#fig-xkcd605" class="quarto-xref">Figure&nbsp;<span class="quarto-unresolved-ref">fig-xkcd605</span></a>.</p>
<div class="cell" data-layout-align="center">
<div class="cell-output-display">
...
<p>To illustrate this point, <a href="#fig-samplevar" class="quarto-xref">Figure&nbsp;<span class="quarto-unresolved-ref">fig-samplevar</span></a> shows five simple random samples of size <span class="math inline">\(n=10\)</span> drawn from an hypothetical population with mean <span class="math inline">\(\mu\)</span> and standard deviation <span class="math inline">\(\sigma,\)</span> along with their sample mean <span class="math inline">\(\overline{y}.\)</span> Because of the sampling variability, the sample means of the subgroups will differ even if they originate from the same distribution. You can view sampling variability as noise: our goal is to extract the signal (typically differences in means) but accounting for spurious results due to the background noise.</p>
<div class="cell" data-layout-align="center">
<div class="cell-output-display">
...
<ul>
<li>the effect size: the bigger the difference between the postulated value for <span class="math inline">\(\theta_0\)</span> under <span class="math inline">\(\mathscr{H}_0\)</span> and the observed behavior, the easier it is to detect it, as in the middle panel of <a href="#fig-power" class="quarto-xref">Figure&nbsp;<span class="quarto-unresolved-ref">fig-power</span></a>;</li>
<li>variability: the less noisy your data, the easier it is to detect differences between the curves (big differences are easier to spot, as the right panel of <a href="#fig-power" class="quarto-xref">Figure&nbsp;<span class="quarto-unresolved-ref">fig-power</span></a> shows);</li>
...
<p><span class="theorem-title"><strong>Example 2.2 (Gender inequality and permutation tests)</strong></span> We consider data from <span class="citation" data-cites="Rosen:1974">Rosen and Jerdee (<a href="#ref-Rosen:1974" role="doc-biblioref">1974</a>)</span>, who look at sex role stereotypes and their impacts on promotion and opportunities for women candidates. The experiment took place in 1972 and the experimental units, which consisted of 95 male bank supervisors, were submitted to various memorandums and asked to provide ratings or decisions based on the information provided.</p>
...
<p>We consider for simplicity only sex as a factor and aggregate over job for the <span class="math inline">\(n=93\)</span> replies. <a href="#tbl-rosen-table1" class="quarto-xref">Table&nbsp;<span class="quarto-unresolved-ref">tbl-rosen-table1</span></a> shows the counts for each possibility.</p>
<div class="cell" data-layout-align="center">
...
<p>The histogram in <a href="#fig-infer-odds-ratio-permutation" class="quarto-xref">Figure&nbsp;<span class="quarto-unresolved-ref">fig-infer-odds-ratio-permutation</span></a> shows the distribution of the odds ratio based on 10 000 permutations. Reassuringly, we again get roughly the same approximate <em>p</em>-value, here 0.002.<a href="#fn4" class="footnote-ref" id="fnref4" role="doc-noteref"><sup>4</sup></a></p>
...
<p><span class="citation" data-cites="Brucks.Levav:2022">Brucks and Levav (<a href="#ref-Brucks.Levav:2022" role="doc-biblioref">2022</a>)</span> used a negative binomial regression model: in their model, the expected number creative ideas generated is <span class="math display">\[\begin{align*}
...
<nav class="page-navigation">
  ...
  <div class="nav-page nav-page-next">
      <a href="./likelihood.html" class="pagination-link" aria-label="Likelihood-based inference">
        <span class="nav-page-text"><span class="chapter-number">3</span>&nbsp; <span class="chapter-title">Likelihood-based inference</span></span> <i class="bi bi-arrow-right-short"></i>
      </a>
  </div>
</nav>
</div> <!-- /content -->
