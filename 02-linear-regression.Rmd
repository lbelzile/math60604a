...
```{r predinterval, cache = TRUE, echo = FALSE, fig.cap = "Prediction for the simple linear regression of buying intention as a function of fixation time. The plot shows predictions along with pointwise 95% confidence intervals of the mean and the individual predictions."}
...
```{r timeresidplot, echo = FALSE, fig.cap= "Lagged residual plots (right). The left panel shows lack of evidence against independence, whereas the right panel shows positively correlated residuals."}
