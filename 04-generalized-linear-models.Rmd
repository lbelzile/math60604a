...
condition, the [Bartlett identities](https://math.stackexchange.com/q/2027660) hold and
\begin{align*}
...
### Diagnostic plots for binary data ($\star$) {#diag-plots-binary}
