...
These notes by Léo Belzile (HEC Montréal) are licensed under a \href{http://creativecommons.org/licenses/by-nc-sa/4.0/}{Creative Commons Attribution-NonCommercial-ShareAlike 4.0 International License} and were last compiled on 2020-12-04.
...
Why use models? \href{https://krugman.blogs.nytimes.com/2010/11/18/debt-deleveraging-and-the-liquidity-trap/}{Paul Krugman wrote in 2010 on his blog}
...
\FunctionTok{data}\NormalTok{(renfe, }\AttributeTok{package =} \StringTok{"hecstatmod"}\NormalTok{)}
...
\NormalTok{renfe\_promo }\OtherTok{\textless{}{-}}\NormalTok{ renfe }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{subset}\NormalTok{(fare }\SpecialCharTok{==} \StringTok{"Promo"}\NormalTok{)}
\CommentTok{\# two{-}sample t{-}test and mean difference}
\NormalTok{ttest }\OtherTok{\textless{}{-}} \FunctionTok{t.test}\NormalTok{(price}\SpecialCharTok{\textasciitilde{}}\NormalTok{dest, }\AttributeTok{data =}\NormalTok{ renfe\_promo)}
...
\FunctionTok{set.seed}\NormalTok{(}\DecValTok{20200608}\NormalTok{) }\CommentTok{\# set seed of pseudo{-}random number generator}
...
\NormalTok{  ttest\_stats[i] }\OtherTok{\textless{}{-}} \FunctionTok{t.test}\NormalTok{(price }\SpecialCharTok{\textasciitilde{}}\NormalTok{ dest[}\FunctionTok{sample.int}\NormalTok{(}\AttributeTok{n =}\NormalTok{ n)], }
...
\FunctionTok{ggplot}\NormalTok{(}\AttributeTok{data =} \FunctionTok{data.frame}\NormalTok{(}\AttributeTok{statistic =}\NormalTok{ ttest\_stats), }
       \FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{statistic)) }\SpecialCharTok{+}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{renfe }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{count}\NormalTok{(class)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{renfe }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{group\_by}\NormalTok{(fare) }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{tally}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{renfe }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{subset}\NormalTok{(duration }\SpecialCharTok{\textgreater{}} \DecValTok{200}\NormalTok{) }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{group\_by}\NormalTok{(type, dest) }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{summarise}\NormalTok{(}\StringTok{"average duration"} \OtherTok{=} \FunctionTok{mean}\NormalTok{(duration), }
            \StringTok{"std. dev"} \OtherTok{=} \FunctionTok{sd}\NormalTok{(duration),}
            \StringTok{"average price"} \OtherTok{=} \FunctionTok{mean}\NormalTok{(price), }
            \StringTok{"std. dev"} \OtherTok{=} \FunctionTok{sd}\NormalTok{(price)) }
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{renfe }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{subset}\NormalTok{(fare  }\SpecialCharTok{!=} \StringTok{"AdultoIda"}\NormalTok{) }\SpecialCharTok{\%\textgreater{}\%}
\FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{y =}\NormalTok{ price, }\AttributeTok{x =}\NormalTok{ class, }\AttributeTok{col =}\NormalTok{ fare)) }\SpecialCharTok{+} 
  \FunctionTok{geom\_boxplot}\NormalTok{() }\SpecialCharTok{+} 
  \FunctionTok{labs}\NormalTok{(}\AttributeTok{y =} \StringTok{"price (in euros)"}\NormalTok{,}
       \AttributeTok{x =} \StringTok{"class"}\NormalTok{,}
       \AttributeTok{color =} \StringTok{"fare"}\NormalTok{) }\SpecialCharTok{+}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{ggplot}\NormalTok{(}\AttributeTok{data =}\NormalTok{ renfe, }\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ price, }\AttributeTok{y=}\NormalTok{..density.., }\AttributeTok{fill =}\NormalTok{ fare)) }\SpecialCharTok{+}
    \FunctionTok{geom\_histogram}\NormalTok{(}\AttributeTok{binwidth =} \DecValTok{5}\NormalTok{) }\SpecialCharTok{+}
    \FunctionTok{labs}\NormalTok{(}\AttributeTok{x =} \StringTok{"price (in euros)"}\NormalTok{, }\AttributeTok{y =} \StringTok{"density"}\NormalTok{) }\SpecialCharTok{+} 
    \FunctionTok{theme}\NormalTok{(}\AttributeTok{legend.position =} \StringTok{"bottom"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{renfe }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{subset}\NormalTok{(fare  }\SpecialCharTok{==} \StringTok{"Flexible"}\NormalTok{) }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{count}\NormalTok{(price, class)}
\end{Highlighting}
\end{Shaded}
...
condition, the \href{https://math.stackexchange.com/q/2027660}{Bartlett identities} hold and
\begin{align*}
...
\hypertarget{model-adjustment-star}{%
\subsection{\texorpdfstring{Model adjustment (\(\star\))}{Model adjustment (\textbackslash star)}}\label{model-adjustment-star}}
...
\end{align*}
where
\[\mathbf{W} = \mathrm{diag}\{w_1,\ldots, w_n\}, \qquad w_i = \frac{\partial \mu_i/\partial \eta_i)^2}{\mathsf{Va}(Y_i)}=\{g'(\mu_i)^2a_i(\phi)V(\mu_i)\}^{-1}.
\]
...
\subsection{\texorpdfstring{Residuals \((\star)\)}{Residuals (\textbackslash star)}}\label{residuals-glm}}
...
\subsection{\texorpdfstring{Diagnostic plots for binary data (\(\star\))}{Diagnostic plots for binary data (\textbackslash star)}}\label{diag-plots-binary}}
