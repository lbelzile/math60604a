...
\begin{tcolorbox}[enhanced jigsaw, colback=white, coltitle=black, colframe=quarto-callout-important-color-frame, bottomtitle=1mm, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Important}, left=2mm, opacityback=0, breakable, opacitybacktitle=0.6, toptitle=1mm, titlerule=0mm, leftrule=.75mm, rightrule=.15mm, arc=.35mm, colbacktitle=quarto-callout-important-color!10!white, toprule=.15mm, bottomrule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, colback=white, coltitle=black, colframe=quarto-callout-caution-color-frame, bottomtitle=1mm, title=\textcolor{quarto-callout-caution-color}{\faFire}\hspace{0.5em}{Caution}, left=2mm, opacityback=0, breakable, opacitybacktitle=0.6, toptitle=1mm, titlerule=0mm, leftrule=.75mm, rightrule=.15mm, arc=.35mm, colbacktitle=quarto-callout-caution-color!10!white, toprule=.15mm, bottomrule=.15mm]
...
\end{align*} where the entries of the observed information matrix are
\begin{align*}
...
\CommentTok{\#\textgreater{} [1] 24.9}
\FunctionTok{pchisq}\NormalTok{(S, }\AttributeTok{df =} \DecValTok{1}\NormalTok{, }\AttributeTok{lower.tail =} \ConstantTok{FALSE}\NormalTok{)}
\CommentTok{\#\textgreater{} [1] 6.18e{-}07}
...
\CommentTok{\#\textgreater{} [1] 60.4}
\NormalTok{pval }\OtherTok{\textless{}{-}} \FunctionTok{pchisq}\NormalTok{(lrt, }\AttributeTok{df =} \DecValTok{1}\NormalTok{, }\AttributeTok{lower.tail =} \ConstantTok{FALSE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
