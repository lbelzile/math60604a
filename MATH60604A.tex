...
\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-important-color-frame, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Important}, rightrule=.15mm, left=2mm, opacityback=0, opacitybacktitle=0.6, colbacktitle=quarto-callout-important-color!10!white, bottomrule=.15mm, toptitle=1mm, coltitle=black, toprule=.15mm, bottomtitle=1mm, leftrule=.75mm, breakable, colback=white, titlerule=0mm, arc=.35mm]
...
\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-caution-color-frame, title=\textcolor{quarto-callout-caution-color}{\faFire}\hspace{0.5em}{Caution}, rightrule=.15mm, left=2mm, opacityback=0, opacitybacktitle=0.6, colbacktitle=quarto-callout-caution-color!10!white, bottomrule=.15mm, toptitle=1mm, coltitle=black, toprule=.15mm, bottomtitle=1mm, leftrule=.75mm, breakable, colback=white, titlerule=0mm, arc=.35mm]
