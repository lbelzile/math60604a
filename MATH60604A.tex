...
\begin{tcolorbox}[enhanced jigsaw, titlerule=0mm, colframe=quarto-callout-important-color-frame, bottomrule=.15mm, left=2mm, coltitle=black, bottomtitle=1mm, colback=white, toptitle=1mm, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Important}, leftrule=.75mm, toprule=.15mm, arc=.35mm, opacitybacktitle=0.6, opacityback=0, rightrule=.15mm, breakable, colbacktitle=quarto-callout-important-color!10!white]
...
\begin{tcolorbox}[enhanced jigsaw, titlerule=0mm, colframe=quarto-callout-caution-color-frame, bottomrule=.15mm, left=2mm, coltitle=black, bottomtitle=1mm, colback=white, toptitle=1mm, title=\textcolor{quarto-callout-caution-color}{\faFire}\hspace{0.5em}{Caution}, leftrule=.75mm, toprule=.15mm, arc=.35mm, opacitybacktitle=0.6, opacityback=0, rightrule=.15mm, breakable, colbacktitle=quarto-callout-caution-color!10!white]
