...
\begin{tcolorbox}[enhanced jigsaw, colback=white, leftrule=.75mm, colframe=quarto-callout-important-color-frame, coltitle=black, colbacktitle=quarto-callout-important-color!10!white, rightrule=.15mm, left=2mm, opacitybacktitle=0.6, bottomrule=.15mm, opacityback=0, breakable, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Important}, bottomtitle=1mm, titlerule=0mm, toptitle=1mm, arc=.35mm, toprule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, colback=white, leftrule=.75mm, colframe=quarto-callout-caution-color-frame, coltitle=black, colbacktitle=quarto-callout-caution-color!10!white, rightrule=.15mm, left=2mm, opacitybacktitle=0.6, bottomrule=.15mm, opacityback=0, breakable, title=\textcolor{quarto-callout-caution-color}{\faFire}\hspace{0.5em}{Caution}, bottomtitle=1mm, titlerule=0mm, toptitle=1mm, arc=.35mm, toprule=.15mm]
