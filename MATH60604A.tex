...
\begin{tcolorbox}[enhanced jigsaw, breakable, toptitle=1mm, colframe=quarto-callout-important-color-frame, coltitle=black, opacitybacktitle=0.6, colbacktitle=quarto-callout-important-color!10!white, leftrule=.75mm, opacityback=0, left=2mm, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Important}, arc=.35mm, toprule=.15mm, bottomtitle=1mm, colback=white, bottomrule=.15mm, titlerule=0mm, rightrule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, breakable, toptitle=1mm, colframe=quarto-callout-caution-color-frame, coltitle=black, opacitybacktitle=0.6, colbacktitle=quarto-callout-caution-color!10!white, leftrule=.75mm, opacityback=0, left=2mm, title=\textcolor{quarto-callout-caution-color}{\faFire}\hspace{0.5em}{Caution}, arc=.35mm, toprule=.15mm, bottomtitle=1mm, colback=white, bottomrule=.15mm, titlerule=0mm, rightrule=.15mm]
