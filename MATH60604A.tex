...
\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-important-color-frame, breakable, left=2mm, bottomrule=.15mm, opacityback=0, leftrule=.75mm, arc=.35mm, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Important}, colbacktitle=quarto-callout-important-color!10!white, opacitybacktitle=0.6, colback=white, bottomtitle=1mm, coltitle=black, toptitle=1mm, titlerule=0mm, rightrule=.15mm, toprule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-caution-color-frame, breakable, left=2mm, bottomrule=.15mm, opacityback=0, leftrule=.75mm, arc=.35mm, title=\textcolor{quarto-callout-caution-color}{\faFire}\hspace{0.5em}{Caution}, colbacktitle=quarto-callout-caution-color!10!white, opacitybacktitle=0.6, colback=white, bottomtitle=1mm, coltitle=black, toptitle=1mm, titlerule=0mm, rightrule=.15mm, toprule=.15mm]
