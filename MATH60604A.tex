...
\begin{tcolorbox}[enhanced jigsaw, rightrule=.15mm, toprule=.15mm, opacitybacktitle=0.6, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Important}, bottomtitle=1mm, colback=white, colframe=quarto-callout-important-color-frame, arc=.35mm, titlerule=0mm, breakable, coltitle=black, toptitle=1mm, colbacktitle=quarto-callout-important-color!10!white, bottomrule=.15mm, leftrule=.75mm, left=2mm, opacityback=0]
...
\begin{tcolorbox}[enhanced jigsaw, rightrule=.15mm, toprule=.15mm, opacitybacktitle=0.6, title=\textcolor{quarto-callout-caution-color}{\faFire}\hspace{0.5em}{Caution}, bottomtitle=1mm, colback=white, colframe=quarto-callout-caution-color-frame, arc=.35mm, titlerule=0mm, breakable, coltitle=black, toptitle=1mm, colbacktitle=quarto-callout-caution-color!10!white, bottomrule=.15mm, leftrule=.75mm, left=2mm, opacityback=0]
