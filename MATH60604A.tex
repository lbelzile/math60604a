...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, leftrule=.75mm, coltitle=black, colframe=quarto-callout-important-color-frame, opacityback=0, colback=white, titlerule=0mm, bottomrule=.15mm, rightrule=.15mm, breakable, colbacktitle=quarto-callout-important-color!10!white, opacitybacktitle=0.6, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Important}, bottomtitle=1mm, toprule=.15mm, toptitle=1mm, arc=.35mm]
...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, leftrule=.75mm, coltitle=black, colframe=quarto-callout-caution-color-frame, opacityback=0, colback=white, titlerule=0mm, bottomrule=.15mm, rightrule=.15mm, breakable, colbacktitle=quarto-callout-caution-color!10!white, opacitybacktitle=0.6, title=\textcolor{quarto-callout-caution-color}{\faFire}\hspace{0.5em}{Caution}, bottomtitle=1mm, toprule=.15mm, toptitle=1mm, arc=.35mm]
