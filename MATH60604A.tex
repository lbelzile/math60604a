...
\begin{tcolorbox}[enhanced jigsaw, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Important}, toptitle=1mm, arc=.35mm, leftrule=.75mm, rightrule=.15mm, colback=white, colframe=quarto-callout-important-color-frame, left=2mm, bottomrule=.15mm, colbacktitle=quarto-callout-important-color!10!white, breakable, opacitybacktitle=0.6, bottomtitle=1mm, toprule=.15mm, titlerule=0mm, opacityback=0, coltitle=black]
...
\begin{tcolorbox}[enhanced jigsaw, title=\textcolor{quarto-callout-caution-color}{\faFire}\hspace{0.5em}{Caution}, toptitle=1mm, arc=.35mm, leftrule=.75mm, rightrule=.15mm, colback=white, colframe=quarto-callout-caution-color-frame, left=2mm, bottomrule=.15mm, colbacktitle=quarto-callout-caution-color!10!white, breakable, opacitybacktitle=0.6, bottomtitle=1mm, toprule=.15mm, titlerule=0mm, opacityback=0, coltitle=black]
