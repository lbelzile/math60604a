...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, colframe=quarto-callout-important-color-frame, toprule=.15mm, opacityback=0, opacitybacktitle=0.6, colbacktitle=quarto-callout-important-color!10!white, titlerule=0mm, bottomtitle=1mm, left=2mm, toptitle=1mm, bottomrule=.15mm, colback=white, rightrule=.15mm, breakable, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Important}, leftrule=.75mm, coltitle=black]
...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, colframe=quarto-callout-caution-color-frame, toprule=.15mm, opacityback=0, opacitybacktitle=0.6, colbacktitle=quarto-callout-caution-color!10!white, titlerule=0mm, bottomtitle=1mm, left=2mm, toptitle=1mm, bottomrule=.15mm, colback=white, rightrule=.15mm, breakable, title=\textcolor{quarto-callout-caution-color}{\faFire}\hspace{0.5em}{Caution}, leftrule=.75mm, coltitle=black]
