...
{\centering \includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio]{images/02-ttest-DF_illustration.png}
...
\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio]{introduction_files/figure-pdf/fig-normal-loc-scale-1.pdf}
...
\(Z = (Y-\mu)/\sigma \sim \mathsf{normal}(0,1).\) Conversely, if
...
\includegraphics[width=0.5\linewidth,height=\textheight,keepaspectratio]{introduction_files/figure-pdf/fig-student-density-1.pdf}
...
\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio]{images/01-intro-boxplot.pdf}
...
\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio]{introduction_files/figure-pdf/fig-scatterplot-1.pdf}
...
\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, opacitybacktitle=0.6, colbacktitle=quarto-callout-important-color!10!white, toptitle=1mm, opacityback=0, arc=.35mm, left=2mm, coltitle=black, rightrule=.15mm, colback=white, titlerule=0mm, breakable, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Important}, bottomrule=.15mm, toprule=.15mm, bottomtitle=1mm, colframe=quarto-callout-important-color-frame]
...
{\centering \includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio]{inference_files/figure-pdf/intconf-1.pdf}
...
\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, opacitybacktitle=0.6, colbacktitle=quarto-callout-caution-color!10!white, toptitle=1mm, opacityback=0, arc=.35mm, left=2mm, coltitle=black, rightrule=.15mm, colback=white, titlerule=0mm, breakable, title=\textcolor{quarto-callout-caution-color}{\faFire}\hspace{0.5em}{Caution}, bottomrule=.15mm, toprule=.15mm, bottomtitle=1mm, colframe=quarto-callout-caution-color-frame]
...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{inference_files/figure-pdf/fig-power-1.pdf}
...
\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio]{likelihood_files/figure-pdf/fig-waiting-hist-1.pdf}
...
{\centering \includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio]{images/likelihood_tests.png}
...
the Wald (denoted \(W\)), likelihood ratio (\(R\)), and the score
(\(S\)) test statistics, defined respectively as \begin{align*}
...
\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio]{likelihood_files/figure-pdf/fig-ellipses-1.pdf}
...
\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio]{likelihood_files/figure-pdf/fig-weibull-profile-1.pdf}
...
\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio]{likelihood_files/figure-pdf/fig-qqplots-weibull-exp-1.pdf}
...
\NormalTok{g2 }\OtherTok{\textless{}{-}} \FunctionTok{ggplot}\NormalTok{(}\AttributeTok{data =}\NormalTok{ prof,}
       \AttributeTok{mapping =} \FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ mu, }\AttributeTok{y =} \DecValTok{2}\SpecialCharTok{*}\NormalTok{(opt\_weibull}\SpecialCharTok{$}\NormalTok{value }\SpecialCharTok{{-}}\NormalTok{ nll))) }\SpecialCharTok{+} 
  \FunctionTok{geom\_line}\NormalTok{() }\SpecialCharTok{+}
  \FunctionTok{geom\_hline}\NormalTok{(}\AttributeTok{yintercept =} \SpecialCharTok{{-}}\FunctionTok{qchisq}\NormalTok{(}\FunctionTok{c}\NormalTok{(}\FloatTok{0.95}\NormalTok{), }\AttributeTok{df =} \DecValTok{1}\NormalTok{),}
             \AttributeTok{linetype =} \StringTok{"dashed"}\NormalTok{) }\SpecialCharTok{+}
  ...
  \FunctionTok{labs}\NormalTok{(}\AttributeTok{x =} \FunctionTok{expression}\NormalTok{(}\FunctionTok{paste}\NormalTok{(}\StringTok{"expectation "}\NormalTok{, mu)),}
       \AttributeTok{y =} \StringTok{"negative of likelihood ratio statistic"}\NormalTok{)}
...
\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio]{likelihood_files/figure-pdf/fig-profile-mu-weibull-1.pdf}
...
\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio]{linearmodels_files/figure-pdf/fig-edacollege-1.pdf}
...
{\centering \includegraphics[width=0.6\linewidth,height=\textheight,keepaspectratio]{images/correlation_causation.jpg}
...
\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio]{linearmodels_files/figure-pdf/fig-droitenuage-1.pdf}
...
\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio]{linearmodels_files/figure-pdf/fig-autoquad2d-1.pdf}
...
\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio]{images/hyperplane_auto.png}
...
\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio]{linearmodels_files/figure-pdf/fig-auto-discre-1.pdf}
...
\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio]{linearmodels_files/figure-pdf/fig-donation-moon-1.pdf}
...
\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio]{linearmodels_files/figure-pdf/fig-vertdist-1.pdf}
...
\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio]{linearmodels_files/figure-pdf/fig-predinterval-1.png}
...
\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio]{linearmodels_files/figure-pdf/fig-interaction-slope-1.pdf}
...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{linearmodels_files/figure-pdf/fig-2by2-1.pdf}
...
\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio]{linearmodels_files/figure-pdf/fig-interaction-ST-1.pdf}
...
\begin{center}
\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio]{linearmodels_files/figure-pdf/unnamed-chunk-48-1.pdf}
\end{center}
...
\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio]{linearmodels_files/figure-pdf/fig-zerocor-1.pdf}
...
\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio]{linearmodels_files/figure-pdf/fig-outliers-1.pdf}
...
\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio]{linearmodels_files/figure-pdf/fig-regdiaglin-1.pdf}
...
\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio]{linearmodels_files/figure-pdf/fig-residhomoscedastic-1.pdf}
...
\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio]{linearmodels_files/figure-pdf/fig-diagfitvalhomosce-1.pdf}
...
\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio]{linearmodels_files/figure-pdf/fig-simuWelchnull-1.pdf}
...
\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio]{linearmodels_files/figure-pdf/fig-plotLevelIndep-1.pdf}
...
\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio]{linearmodels_files/figure-pdf/fig-timeresidplot-1.pdf}
...
\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio]{linearmodels_files/figure-pdf/fig-correlogram-1.pdf}
...
\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio]{linearmodels_files/figure-pdf/fig-qqplotresid-1.pdf}
...
\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio]{linearmodels_files/figure-pdf/fig-qqplotsbad-1.pdf}
...
\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio]{linearmodels_files/figure-pdf/fig-diagplotscollege-1.pdf}
...
\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio]{linearmodels_files/figure-pdf/fig-poisonplots-1.pdf}
